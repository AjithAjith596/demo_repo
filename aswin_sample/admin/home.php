...
<div class="container">
  <hgroup>
    <h1 class="site-title" style="text-align: center; color: green;">FILE MANAGEMENT SYSTEM</h1><br>
  </hgroup>
  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav center">
       <li><a href="fetch_user.php">User</a></li> 
       <li><a href="fetch_admin.php">Admin</a></li> 
   ...
   <?php if($allow_upload): ?>
	...
	<!--	<input type="file" multiple />   --> 
         ...
         <form method="POST" enctype="multipart/form-data" action="save_file.php">
					...
					<br />
					<button class="btn btn-success btn-sm" name="save">upload</button>
				</form>
